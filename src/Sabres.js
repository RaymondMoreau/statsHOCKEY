        ...
        <Container class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <h1>BUFFALO SABRES</h1>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Top Forward: Tage Thompson</b><br></br>
                            <p>GP: 78, G: 38, A: 30, PTS: 68</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Best Defender: Ramus Dahlin</b><br></br>
                            <p>GP: 80, G: 13, A: 40, PTS: 53</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Starting Goalie: Craig Anderson</b><br></br>
                        </Card.Text>
                    </Card.Body>
                </Card>
