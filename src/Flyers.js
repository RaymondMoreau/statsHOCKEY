...
function Flyers() {
    ...
    return (
        ...
        <Container class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <h1>PHILADELPHIA FLYERS</h1>
                <Card className="py-4">
                    <Card.Img variant="top" src="./statsHOCKEY/assets/rink.jpg" />
                    <Card.Body>
                        <Card.Text>
                            <b>Top Forward: Travis Konecny</b><br></br>
                            <p>GP: 79, G: 16, A: 36, PTS: 52</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Best Defender: Ivan Provorov</b><br></br>
                            <p>GP: 79, G: 9, A: 22, PTS: 31</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Starting Goalie: Carter Hart</b><br></br>
                        </Card.Text>
                    </Card.Body>
                </Card>
