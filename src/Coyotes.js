...
function Coyotes() {
    ...
    return (
        ...
        <Container class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <h1>ARIZONA COYOTES</h1>
                <Card className="py-4">
                    <Card.Img variant="top" src="./statsHOCKEY/assets/rink.jpg" />
                    <Card.Body>
                        <Card.Text>
                            <b>Top Forward: Clayton Keller</b><br></br>
                            <p>GP: 67, G: 28, A: 35, PTS: 63</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Best Defender: Shayne Gostisbehere</b><br></br>
                            <p>GP: 82, G: 15, A: 37, PTS: 51</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Starting Goalie: Karel Vejmelka</b><br></br>
                        </Card.Text>
                    </Card.Body>
                </Card>
