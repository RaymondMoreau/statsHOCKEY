...
function GoldenKnights() {
    ...
    return (
        ...
        <Container class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <h1>LAS VEGAS GOLDEN KNIGHTS</h1>
                <Card className="py-4">
                    <Card.Img variant="top" src="./statsHOCKEY/assets/rink.jpg" />
                    <Card.Body>
                        <Card.Text>
                            <b>Top Forward: Johnathan Marchessault</b><br></br>
                            <p>GP: 76, G: 30, A: 36, PTS: 66</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Best Defender: Shea Theodore</b><br></br>
                            <p>GP: 78, G: 14, A: 38, PTS: 52</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Starting Goalie: Robin Lehner</b><br></br>
                        </Card.Text>
                    </Card.Body>
                </Card>
