        ...
        <Container class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <h1>SEATTLE KRAKEN</h1>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Top Forward: Jared McCann</b><br></br>
                            <p>GP: 74, G: 27, A: 23, PTS: 50</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Best Defender: Vince Dunn</b><br></br>
                            <p>GP: 73, G: 7, A: 28, PTS: 35</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Starting Goalie: Philipp Grubauer</b><br></br>
                        </Card.Text>
                    </Card.Body>
                </Card>
