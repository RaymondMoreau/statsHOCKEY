        ...
        <Container class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <h1>EDMONTON OILERS</h1>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Top Forward: Connor McDavid</b><br></br>
                            <p>GP: 80, G: 44, A: 79, PTS: 123</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Best Defender: Evan Bouchard</b><br></br>
                            <p>GP: 81, G: 12, A: 31, PTS: 43</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Starting Goalie: Mikko Koskinen</b><br></br>
                        </Card.Text>
                    </Card.Body>
                </Card>
