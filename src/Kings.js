...
function Kings() {
    ...
    return (
        ...
        <Container class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <h1>LOS ANGELES KINGS</h1>
                <Card className="py-4">
                    <Card.Img variant="top" src="./statsHOCKEY/assets/rink.jpg" />
                    <Card.Body>
                        <Card.Text>
                            <b>Top Forward: Anze Kopitar</b><br></br>
                            <p>GP: 81, G: 19, A: 48, PTS: 67</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Best Defender: Drew Doughty</b><br></br>
                            <p>GP: 39, G: 7, A: 24, PTS: 31</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Starting Goalie: Johnathan Quick</b><br></br>
                        </Card.Text>
                    </Card.Body>
                </Card>
