        ...
        <Container class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <h1>DALLAS STARS</h1>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Top Forward: Joe Pavelski</b><br></br>
                            <p>GP: 82, G: 27, A: 54, PTS: 81</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Best Defender: John Klingberg</b><br></br>
                            <p>GP: 74, G: 6, A: 41, PTS: 47</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Starting Goalie: Jake Oettinger</b><br></br>
                        </Card.Text>
                    </Card.Body>
                </Card>
