        ...
        <Container class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <h1>NEW YORK ISLANDERS</h1>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Top Forward: Brock Nelson</b><br></br>
                            <p>GP: 72, G: 37, A: 22, PTS: 59</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Best Defender: Noah Dobson</b><br></br>
                            <p>GP: 80, G: 13, A: 38, PTS: 51</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Starting Goalie: Ilya Sorokin</b><br></br>
                        </Card.Text>
                    </Card.Body>
                </Card>
