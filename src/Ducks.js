        ...
        <Container class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <h1>ANAHEIM DUCKS</h1>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Top Forward: Troy Terry</b><br></br>
                            <p>GP: 75, G: 37, A: 30, PTS: 67</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Best Defender: Cam Fowler</b><br></br>
                            <p>GP: 76, G: 9, A: 33, PTS: 42</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Starting Goalie: John Gibson</b><br></br>
                        </Card.Text>
                    </Card.Body>
                </Card>
