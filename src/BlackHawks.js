        ...
        <Container class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <h1>CHICAGO BLACKHAWKS</h1>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Top Forward: Patrick Kane</b><br></br>
                            <p>GP: 78, G: 26, A: 66, PTS: 92</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Best Defender: Seth Jones</b><br></br>
                            <p>GP: 78, G: 5, A: 46, PTS: 51</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Starting Goalie: Marc-Andre Fleury</b><br></br>
                        </Card.Text>
                    </Card.Body>
                </Card>
