        ...
        <Container class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <h1>TORONTO MAPLE LEAFS</h1>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Top Forward: Auston Matthews</b><br></br>
                            <p>GP: 73, G: 60, A: 46, PTS: 106</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Best Defender: Morgan Rielly</b><br></br>
                            <p>GP: 82, G: 10, A: 58, PTS: 68</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Starting Goalie: Jack Campbell</b><br></br>
                        </Card.Text>
                    </Card.Body>
                </Card>
