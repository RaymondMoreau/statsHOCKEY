    ...
    return (
        ...
        <Row>
            <Col xs={3}>
                ...
                <div className="py-5 px-2 d-grid gap-2">
                    <Button variant="secondary" size="lg" onClick={() => {navigate("/GraphFive")}}>
                        Top Teams
                    </Button>
                </div>
            </Col>
            ...
            <Card className="bg-dark text-white">
                <Card.Img src="./statsHOCKEY/assets/teams.png" alt="image of graph representing teams who performed the best in the playoffs" />
                <Card.ImgOverlay>
