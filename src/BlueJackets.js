        ...
        <Container class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <h1>COLUMBUS BLUE JACKETS</h1>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Top Forward: Jakub Voracek</b><br></br>
                            <p>GP: 79, G: 6, A: 56, PTS: 62</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Best Defender: Zach Werenski</b><br></br>
                            <p>GP: 68, G: 11, A: 37, PTS: 48</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Starting Goalie: Elvis Merzlikins</b><br></br>
                        </Card.Text>
                    </Card.Body>
                </Card>
