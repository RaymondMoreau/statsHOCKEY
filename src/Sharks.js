        ...
        <Container class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <h1>SAN JOSE SHARKS</h1>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Top Forward: Timo Meier</b><br></br>
                            <p>GP: 77, G: 35, A: 41, PTS: 76</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Best Defender: Brent Burns</b><br></br>
                            <p>GP: 82, G: 10, A: 44, PTS: 54</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Starting Goalie: James Reimer</b><br></br>
                        </Card.Text>
                    </Card.Body>
                </Card>
