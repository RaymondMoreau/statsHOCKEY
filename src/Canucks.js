        ...
        <Container class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <h1>VANCOUVER CANUCKS</h1>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Top Forward: J.T. Miller</b><br></br>
                            <p>GP: 80, G: 32, A: 67, PTS: 99</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Best Defender: Quinn Hughes</b><br></br>
                            <p>GP: 76, G: 8, A: 60, PTS: 68</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Starting Goalie: Thatcher Demko</b><br></br>
                        </Card.Text>
                    </Card.Body>
                </Card>
