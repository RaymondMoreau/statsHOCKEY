    ...
    return (
        ...
        <Row>
            <Col xs={3}>
                ...
                <div className="py-5 px-2 d-grid gap-2">
                    <Button variant="secondary" size="lg" onClick={() => {navigate("/GraphFour")}}>
                        Teams Win Streaking
                    </Button>
                </div>
                <div className="py-5 px-2 d-grid gap-2">
            ...
            <Card className="bg-dark text-white">
                <Card.Img src="./statsHOCKEY/assets/streak.png" alt="image of graph representing teams who win streaked the most during the 2021-2022 season" />
                <Card.ImgOverlay>
