        ...
        <Container class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <h1>NEW JERSEY DEVILS</h1>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Top Forward: Jesper Bratt</b><br></br>
                            <p>GP: 76, G: 26, A: 47, PTS: 73</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Best Defender: Damon Severson</b><br></br>
                            <p>GP: 80, G: 11, A: 35, PTS: 46</p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                <Card className="py-4">
                    ...
                    <Card.Body>
                        <Card.Text>
                            <b>Starting Goalie: Mackenzie Blackwood</b><br></br>
                        </Card.Text>
                    </Card.Body>
                </Card>
